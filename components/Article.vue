    ...
    <div>
        <NuxtLink v-for="post in postArray" :key="post.posts_id" :to="`/blog/${post.posts_id}`" class="hover:none">
            <div class="w-full my-2">
                ...
                <div class="m-2 lg:my-4 lg:mx-2">
                    <h6 class="text-base">Article 1. Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                ...
                <span class="w-8 h-8 bg-green-500"></span>
                <span class="w-8 h-8 bg-red-500"></span>
                <span class="w-8 h-8 bg-cyan-500"></span>
                </div> -->
                    ...
                    <!-- Data -->
                    <div class="flex flex-col items-center mx-2 font-bold lg:hidden">
                        <!-- <h1>{{ post.posts_view }}</h1> -->
                        <h1>999</h1>
                        <h1 class="text-xs">Shares</h1>
                    </div>
                </div>
...
<script setup>
const postArray = ref('')
const { data: postList } = await useFetch('http://127.0.0.1:8000/api/all_post')
postArray.value = JSON.parse(postList.value)
